...
import {PaperInputHelper, PaperInputBehavior} from '../../@polymer/paper-input/paper-input-behavior.js';
 ...
 */
class PaperCombobox extends mixinBehaviors([
  IronFormElementBehavior, PaperInputBehavior], PolymerElement) {
  static get template() {
    return html`
    <style>
    :host {
    ...
    <paper-autocomplete target="[[_focusInputElement]]" source="[[source]]" opened="{{opened}}" on-selected="_onSelected" open-on-focus="">
  </paper-autocomplete>
`;
  }

  static get is() {
    return 'paper-combobox';
  }
